...
// Preloaded ahead of the Google Fonts @import in globals.css so Lora/Fraunces
// don't show a flash of unstyled text on first paint. Only the "vietnamese"
// and "latin" subset files are preloaded — the two that actually cover this
// site's copy; these hashed gstatic URLs are pinned to the current font
// version and will need re-fetching (see app/globals.css's @import lines)
...
const FONT_PRELOADS = [
  ...
  "https://fonts.gstatic.com/s/fraunces/v38/6NUu8FyLNQOQZAnv9bYEvDiIdE9Ea92uemAk_WBq8U_9v0c2Wa0K7iN7iQcIfJD58njU0oc0qv86Rg.woff2",
  "https://fonts.gstatic.com/s/fraunces/v38/6NUu8FyLNQOQZAnv9bYEvDiIdE9Ea92uemAk_WBq8U_9v0c2Wa0K7iN7iQcIfJD58njU0oc7qv8.woff2",
];
