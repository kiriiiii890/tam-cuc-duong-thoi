...
// the page (e.g. the Vietnamese diacritics in a Lora heading in the FAQ
// section) has actually been requested — the class flips on, the text
...
// only settles once it's loaded.
const SAMPLE = "Đương Thời ẩ ế ề ệ ỉ ỏ ồ ộ ớ ờ ừ ấ";

export default function FontReady() {
  useEffect(() => {
    Promise.all([document.fonts.load('700 16px "Lora"', SAMPLE), document.fonts.ready]).then(
      () => {
